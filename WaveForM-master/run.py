...
#patching
parser.add_argument('--patch_len',type=int, default=16, help='the patch length' )
parser.add_argument('--stride',type=int, default=5, help='the patch stride'  )
parser.add_argument('--padding_patch',type=str, default='end', help='the padding patch'  )
